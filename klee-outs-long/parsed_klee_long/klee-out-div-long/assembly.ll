...
define i32 @main() #0 {
  ...
  %input = alloca [2 x float], align 4
  %a = alloca float, align 4
  %b = alloca float, align 4
  %r = alloca float, align 4
  store i32 0, i32* %1
  %2 = getelementptr inbounds [2 x float]* %input, i32 0, i32 0
  %3 = bitcast float* %2 to i8*
  call void @klee_make_symbolic(i8* %3, i64 8, i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0))
  %4 = getelementptr inbounds [2 x float]* %input, i32 0, i64 0
  %5 = load float* %4, align 4
  store volatile float %5, float* %a, align 4
  %6 = getelementptr inbounds [2 x float]* %input, i32 0, i64 1
  %7 = load float* %6, align 4
  store volatile float %7, float* %b, align 4
  %8 = load volatile float* %a, align 4
  %9 = load volatile float* %b, align 4
  %10 = fdiv float %8, %9
  store volatile float %10, float* %r, align 4
  %11 = load volatile float* %r, align 4
  %12 = fpext float %11 to double
  %13 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i32 0, i32 0), double %12)
  ret i32 0
}
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([81 x i8]* @.str2, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str13, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str24, i64 0, i64 0)) #12, !dbg !300
  unreachable, !dbg !300
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #12, !dbg !306
  unreachable, !dbg !306
