; ModuleID = 'log-SYMBOLIC-internal.linked.bc'
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = bitcast float* %input to i8*, !dbg !239
  call void @klee_make_symbolic(i8* %2, i64 4, i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0)), !dbg !239
  %3 = load float* %input, align 4, !dbg !240
  store volatile float %3, float* %x, align 4, !dbg !240
  %4 = load volatile float* %x, align 4, !dbg !241
  %5 = call float @logf(float %4) #7, !dbg !241
  store volatile float %5, float* %r, align 4, !dbg !241
  %6 = load volatile float* %r, align 4, !dbg !242
  %7 = fpext float %6 to double, !dbg !242
  %8 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i32 0, i32 0), double %7), !dbg !242
  ret i32 0, !dbg !243
}
...
; <label>:23                                      ; preds = %10
  ...
  %29 = load i64* %28, align 8, !tbaa !248
...
define void @cancel_injection(i8* nocapture readonly %psrc1, i8* nocapture readonly %psrc2, i8* nocapture readonly %pdest) #4 {
  ...
  %2 = load i64* %1, align 8, !tbaa !248
  %int_cast_to_i64 = bitcast i64 52 to i64
  call void @klee_overshift_check(i64 64, i64 %int_cast_to_i64)
  %3 = lshr i64 %2, 52
  %4 = and i64 %3, 2047
  %5 = bitcast i8* %psrc2 to i64*
  %6 = load i64* %5, align 8, !tbaa !248
  %int_cast_to_i641 = bitcast i64 52 to i64
  call void @klee_overshift_check(i64 64, i64 %int_cast_to_i641)
  %7 = lshr i64 %6, 52
  %8 = and i64 %7, 2047
  ...
  %14 = load i64* %13, align 8, !tbaa !248
...
define void @log_sampled_fp_injection(i8* nocapture readonly %psrc1, i8* nocapture readonly %psrc2, i8* nocapture readonly %pdest, i32* nocapture %pcounter, i32 %step, i32 %injection) #4 {
  %1 = load i32* %pcounter, align 4, !tbaa !250
  %2 = icmp eq i32 %1, 2147483647
  br i1 %2, label %round_injection.exit, label %3

; <label>:3                                       ; preds = %0
  %4 = add nsw i32 %1, 1
  store i32 %4, i32* %pcounter, align 4, !tbaa !250
  ...
  %10 = icmp eq i32 %9, 1
  %11 = load i32* %pcounter, align 4, !tbaa !250
...
; <label>:19                                      ; preds = %16
  ...
  %21 = load i64* %20, align 8, !tbaa !248
  %int_cast_to_i642 = bitcast i64 52 to i64
  call void @klee_overshift_check(i64 64, i64 %int_cast_to_i642)
  %22 = lshr i64 %21, 52
  %23 = and i64 %22, 2047
  %24 = bitcast i8* %psrc2 to i64*
  %25 = load i64* %24, align 8, !tbaa !248
  %int_cast_to_i643 = bitcast i64 52 to i64
  call void @klee_overshift_check(i64 64, i64 %int_cast_to_i643)
  %26 = lshr i64 %25, 52
  %27 = and i64 %26, 2047
...
; <label>:10                                      ; preds = %7
  ...
  %12 = load i64* %11, align 8, !tbaa !248
  %int_cast_to_i641 = bitcast i64 52 to i64
  call void @klee_overshift_check(i64 64, i64 %int_cast_to_i641)
  %13 = lshr i64 %12, 52
  %14 = and i64 %13, 2047
  %15 = bitcast i8* %psrc2 to i64*
  %16 = load i64* %15, align 8, !tbaa !248
  %int_cast_to_i642 = bitcast i64 52 to i64
  call void @klee_overshift_check(i64 64, i64 %int_cast_to_i642)
  %17 = lshr i64 %16, 52
  %18 = and i64 %17, 2047
...
define double @klee_internal_fabs(double %d) #4 {
  %1 = tail call double @klee_abs_double(double %d) #12, !dbg !252
  ret double %1, !dbg !252
}
...
define float @klee_internal_fabsf(float %f) #4 {
  %1 = tail call float @klee_abs_float(float %f) #12, !dbg !253
  ret float %1, !dbg !253
}
...
define x86_fp80 @klee_internal_fabsl(x86_fp80 %f) #4 {
  %1 = tail call x86_fp80 @klee_abs_long_double(x86_fp80 %f) #12, !dbg !254
  ret x86_fp80 %1, !dbg !254
}
...
define i32 @klee_internal_fegetround() #4 {
  %1 = tail call i32 (...)* @klee_get_rounding_mode() #12, !dbg !255
  %2 = icmp ult i32 %1, 5, !dbg !256
  br i1 %2, label %switch.lookup, label %4, !dbg !256

switch.lookup:                                    ; preds = %0
  %3 = sext i32 %1 to i64, !dbg !256
  %switch.gep = getelementptr inbounds [5 x i32]* @switch.table, i64 0, i64 %3, !dbg !256
  %switch.load = load i32* %switch.gep, align 4, !dbg !256
  ret i32 %switch.load, !dbg !256
...
; <label>:1                                       ; preds = %0
  tail call void @klee_set_rounding_mode(i32 0) #12, !dbg !259
  br label %5, !dbg !261

; <label>:2                                       ; preds = %0
  tail call void @klee_set_rounding_mode(i32 2) #12, !dbg !262
  br label %5, !dbg !263

; <label>:3                                       ; preds = %0
  tail call void @klee_set_rounding_mode(i32 3) #12, !dbg !264
  br label %5, !dbg !265

; <label>:4                                       ; preds = %0
  tail call void @klee_set_rounding_mode(i32 4) #12, !dbg !266
  br label %5, !dbg !267
...
define i32 @klee_internal_isnanf(float %f) #4 {
  %1 = tail call zeroext i1 @klee_is_nan_float(float %f) #12, !dbg !269
...
define i32 @klee_internal_isnan(double %d) #4 {
  %1 = tail call zeroext i1 @klee_is_nan_double(double %d) #12, !dbg !270
...
define i32 @klee_internal_isnanl(x86_fp80 %d) #4 {
  %1 = tail call zeroext i1 @klee_is_nan_long_double(x86_fp80 %d) #12, !dbg !271
...
define i32 @klee_internal_fpclassifyf(float %f) #4 {
  %1 = tail call zeroext i1 @klee_is_nan_float(float %f) #12, !dbg !272
  br i1 %1, label %8, label %2, !dbg !272

; <label>:2                                       ; preds = %0
  %3 = tail call zeroext i1 @klee_is_infinite_float(float %f) #12, !dbg !274
  br i1 %3, label %8, label %4, !dbg !274

; <label>:4                                       ; preds = %2
  %5 = fcmp oeq float %f, 0.000000e+00, !dbg !276
  br i1 %5, label %8, label %6, !dbg !276

; <label>:6                                       ; preds = %4
  %7 = tail call zeroext i1 @klee_is_normal_float(float %f) #12, !dbg !278
  %. = select i1 %7, i32 4, i32 3, !dbg !280
  br label %8, !dbg !280
...
define i32 @klee_internal_fpclassify(double %f) #4 {
  %1 = tail call zeroext i1 @klee_is_nan_double(double %f) #12, !dbg !283
  br i1 %1, label %8, label %2, !dbg !283

; <label>:2                                       ; preds = %0
  %3 = tail call zeroext i1 @klee_is_infinite_double(double %f) #12, !dbg !285
  br i1 %3, label %8, label %4, !dbg !285

; <label>:4                                       ; preds = %2
  %5 = fcmp oeq double %f, 0.000000e+00, !dbg !287
  br i1 %5, label %8, label %6, !dbg !287

; <label>:6                                       ; preds = %4
  %7 = tail call zeroext i1 @klee_is_normal_double(double %f) #12, !dbg !289
...
define i32 @klee_internal_fpclassifyl(x86_fp80 %ld) #4 {
  %1 = tail call zeroext i1 @klee_is_nan_long_double(x86_fp80 %ld) #12, !dbg !294
  br i1 %1, label %8, label %2, !dbg !294

; <label>:2                                       ; preds = %0
  %3 = tail call zeroext i1 @klee_is_infinite_long_double(x86_fp80 %ld) #12, !dbg !296
  br i1 %3, label %8, label %4, !dbg !296

; <label>:4                                       ; preds = %2
  %5 = fcmp oeq x86_fp80 %ld, 0xK00000000000000000000, !dbg !298
  br i1 %5, label %8, label %6, !dbg !298

; <label>:6                                       ; preds = %4
  %7 = tail call zeroext i1 @klee_is_normal_long_double(x86_fp80 %ld) #12, !dbg !300
...
define i32 @klee_internal_finitef(float %f) #4 {
  %1 = tail call zeroext i1 @klee_is_nan_float(float %f) #12, !dbg !305
  %2 = zext i1 %1 to i32, !dbg !305
  %3 = xor i32 %2, 1, !dbg !305
  %4 = tail call zeroext i1 @klee_is_infinite_float(float %f) #12, !dbg !305
...
define i32 @klee_internal_finite(double %f) #4 {
  %1 = tail call zeroext i1 @klee_is_nan_double(double %f) #12, !dbg !306
  %2 = zext i1 %1 to i32, !dbg !306
  %3 = xor i32 %2, 1, !dbg !306
  %4 = tail call zeroext i1 @klee_is_infinite_double(double %f) #12, !dbg !306
...
define i32 @klee_internal_finitel(x86_fp80 %f) #4 {
  %1 = tail call zeroext i1 @klee_is_nan_long_double(x86_fp80 %f) #12, !dbg !307
  %2 = zext i1 %1 to i32, !dbg !307
  %3 = xor i32 %2, 1, !dbg !307
  %4 = tail call zeroext i1 @klee_is_infinite_long_double(x86_fp80 %f) #12, !dbg !307
...
define void @klee_div_zero_check(i64 %z) #4 {
  %1 = icmp eq i64 %z, 0, !dbg !308
  br i1 %1, label %2, label %3, !dbg !308

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([81 x i8]* @.str2, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str13, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str24, i64 0, i64 0)) #13, !dbg !310
  unreachable, !dbg !310
...
define i32 @klee_int(i8* %name) #4 {
  ...
  %1 = bitcast i32* %x to i8*, !dbg !312
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #12, !dbg !312
  %2 = load i32* %x, align 4, !dbg !313, !tbaa !250
  ret i32 %2, !dbg !313
}

; Function Attrs: nounwind uwtable
define void @klee_overshift_check(i64 %bitWidth, i64 %shift) #4 {
  %1 = icmp ult i64 %shift, %bitWidth, !dbg !314
  br i1 %1, label %3, label %2, !dbg !314

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #13, !dbg !316
  unreachable, !dbg !316
...
define i32 @klee_range(i32 %start, i32 %end, i8* %name) #4 {
  %x = alloca i32, align 4
  %1 = icmp slt i32 %start, %end, !dbg !319
  br i1 %1, label %3, label %2, !dbg !319

; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([72 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #13, !dbg !321
  unreachable, !dbg !321

; <label>:3                                       ; preds = %0
  %4 = add nsw i32 %start, 1, !dbg !322
  %5 = icmp eq i32 %4, %end, !dbg !322
  br i1 %5, label %21, label %6, !dbg !322

; <label>:6                                       ; preds = %3
  %7 = bitcast i32* %x to i8*, !dbg !324
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #12, !dbg !324
  %8 = icmp eq i32 %start, 0, !dbg !326
  %9 = load i32* %x, align 4, !dbg !328, !tbaa !250
  br i1 %8, label %10, label %13, !dbg !326

; <label>:10                                      ; preds = %6
  %11 = icmp ult i32 %9, %end, !dbg !328
  %12 = zext i1 %11 to i64, !dbg !328
  call void @klee_assume(i64 %12) #12, !dbg !328
  br label %19, !dbg !330

; <label>:13                                      ; preds = %6
  %14 = icmp sge i32 %9, %start, !dbg !331
  %15 = zext i1 %14 to i64, !dbg !331
  call void @klee_assume(i64 %15) #12, !dbg !331
  %16 = load i32* %x, align 4, !dbg !333, !tbaa !250
  %17 = icmp slt i32 %16, %end, !dbg !333
  %18 = zext i1 %17 to i64, !dbg !333
  call void @klee_assume(i64 %18) #12, !dbg !333
  br label %19

; <label>:19                                      ; preds = %13, %10
  %20 = load i32* %x, align 4, !dbg !334, !tbaa !250
  br label %21, !dbg !334
...
; <label>:1                                       ; preds = %0
  tail call void @klee_set_rounding_mode_internal(i32 0) #12, !dbg !337
  br label %7, !dbg !337

; <label>:2                                       ; preds = %0
  tail call void @klee_set_rounding_mode_internal(i32 1) #12, !dbg !339
  br label %7, !dbg !339

; <label>:3                                       ; preds = %0
  tail call void @klee_set_rounding_mode_internal(i32 2) #12, !dbg !340
  br label %7, !dbg !340

; <label>:4                                       ; preds = %0
  tail call void @klee_set_rounding_mode_internal(i32 3) #12, !dbg !341
  br label %7, !dbg !341

; <label>:5                                       ; preds = %0
  tail call void @klee_set_rounding_mode_internal(i32 4) #12, !dbg !342
  br label %7, !dbg !342

; <label>:6                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([84 x i8]* @.str9, i64 0, i64 0), i32 31, i8* getelementptr inbounds ([22 x i8]* @.str110, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str211, i64 0, i64 0)) #13, !dbg !343
  unreachable, !dbg !343
...
define weak i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #4 {
  %1 = icmp eq i64 %len, 0, !dbg !345
  br i1 %1, label %._crit_edge, label %.lr.ph.preheader, !dbg !345
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %3 = bitcast i8* %next.gep to <16 x i8>*, !dbg !346
  %wide.load = load <16 x i8>* %3, align 1, !dbg !346
  %next.gep.sum279 = or i64 %index, 16, !dbg !346
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum279, !dbg !346
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !346
  %wide.load200 = load <16 x i8>* %5, align 1, !dbg !346
  %6 = bitcast i8* %next.gep103 to <16 x i8>*, !dbg !346
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !346
  %next.gep103.sum296 = or i64 %index, 16, !dbg !346
  %7 = getelementptr i8* %destaddr, i64 %next.gep103.sum296, !dbg !346
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !346
  store <16 x i8> %wide.load200, <16 x i8>* %8, align 1, !dbg !346
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
  br i1 %9, label %middle.block, label %vector.body, !llvm.loop !347
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %10 = add i64 %.01, -1, !dbg !345
  %11 = getelementptr inbounds i8* %src.03, i64 1, !dbg !346
  %12 = load i8* %src.03, align 1, !dbg !346, !tbaa !350
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !346
  store i8 %12, i8* %dest.02, align 1, !dbg !346, !tbaa !350
  %14 = icmp eq i64 %10, 0, !dbg !345
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !345, !llvm.loop !351

._crit_edge:                                      ; preds = %.lr.ph, %middle.block, %0
  ret i8* %destaddr, !dbg !352
}

; Function Attrs: nounwind uwtable
define weak i8* @memmove(i8* %dst, i8* %src, i64 %count) #4 {
  %1 = icmp eq i8* %src, %dst, !dbg !353
  br i1 %1, label %.loopexit, label %2, !dbg !353

; <label>:2                                       ; preds = %0
  %3 = icmp ugt i8* %src, %dst, !dbg !355
  br i1 %3, label %.preheader, label %18, !dbg !355

.preheader:                                       ; preds = %2
  %4 = icmp eq i64 %count, 0, !dbg !357
  br i1 %4, label %.loopexit, label %.lr.ph.preheader, !dbg !357
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %6 = bitcast i8* %next.gep to <16 x i8>*, !dbg !357
  %wide.load = load <16 x i8>* %6, align 1, !dbg !357
  %next.gep.sum586 = or i64 %index, 16, !dbg !357
  %7 = getelementptr i8* %src, i64 %next.gep.sum586, !dbg !357
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !357
  %wide.load207 = load <16 x i8>* %8, align 1, !dbg !357
  %9 = bitcast i8* %next.gep110 to <16 x i8>*, !dbg !357
  store <16 x i8> %wide.load, <16 x i8>* %9, align 1, !dbg !357
  %next.gep110.sum603 = or i64 %index, 16, !dbg !357
  %10 = getelementptr i8* %dst, i64 %next.gep110.sum603, !dbg !357
  %11 = bitcast i8* %10 to <16 x i8>*, !dbg !357
  store <16 x i8> %wide.load207, <16 x i8>* %11, align 1, !dbg !357
  %index.next = add i64 %index, 32
  %12 = icmp eq i64 %index.next, %n.vec
  br i1 %12, label %middle.block, label %vector.body, !llvm.loop !359
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %13 = add i64 %.02, -1, !dbg !357
  %14 = getelementptr inbounds i8* %b.04, i64 1, !dbg !357
  %15 = load i8* %b.04, align 1, !dbg !357, !tbaa !350
  %16 = getelementptr inbounds i8* %a.03, i64 1, !dbg !357
  store i8 %15, i8* %a.03, align 1, !dbg !357, !tbaa !350
  %17 = icmp eq i64 %13, 0, !dbg !357
  br i1 %17, label %.loopexit, label %.lr.ph, !dbg !357, !llvm.loop !360

; <label>:18                                      ; preds = %2
  %19 = add i64 %count, -1, !dbg !361
  %20 = icmp eq i64 %count, 0, !dbg !363
  br i1 %20, label %.loopexit, label %.lr.ph9, !dbg !363

.lr.ph9:                                          ; preds = %18
  %21 = getelementptr inbounds i8* %src, i64 %19, !dbg !364
  %22 = getelementptr inbounds i8* %dst, i64 %19, !dbg !361
...
vector.body209:                                   ; preds = %vector.body209, %vector.memcheck224
  ...
  %next.gep236.sum = add i64 %.sum440, -15, !dbg !363
  %24 = getelementptr i8* %src, i64 %next.gep236.sum, !dbg !363
  %25 = bitcast i8* %24 to <16 x i8>*, !dbg !363
  %wide.load434 = load <16 x i8>* %25, align 1, !dbg !363
  %reverse = shufflevector <16 x i8> %wide.load434, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !363
  %.sum505 = add i64 %.sum440, -31, !dbg !363
  %26 = getelementptr i8* %src, i64 %.sum505, !dbg !363
  %27 = bitcast i8* %26 to <16 x i8>*, !dbg !363
  %wide.load435 = load <16 x i8>* %27, align 1, !dbg !363
  %reverse436 = shufflevector <16 x i8> %wide.load435, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !363
  %reverse437 = shufflevector <16 x i8> %reverse, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !363
  %next.gep333.sum = add i64 %.sum472, -15, !dbg !363
  %28 = getelementptr i8* %dst, i64 %next.gep333.sum, !dbg !363
  %29 = bitcast i8* %28 to <16 x i8>*, !dbg !363
  store <16 x i8> %reverse437, <16 x i8>* %29, align 1, !dbg !363
  %reverse438 = shufflevector <16 x i8> %reverse436, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !363
  %.sum507 = add i64 %.sum472, -31, !dbg !363
  %30 = getelementptr i8* %dst, i64 %.sum507, !dbg !363
  %31 = bitcast i8* %30 to <16 x i8>*, !dbg !363
  store <16 x i8> %reverse438, <16 x i8>* %31, align 1, !dbg !363
  %index.next234 = add i64 %index212, 32
  %32 = icmp eq i64 %index.next234, %n.vec215
  br i1 %32, label %middle.block210, label %vector.body209, !llvm.loop !365
...
scalar.ph211:                                     ; preds = %scalar.ph211, %middle.block210
  ...
  %33 = add i64 %.16, -1, !dbg !363
  %34 = getelementptr inbounds i8* %b.18, i64 -1, !dbg !363
  %35 = load i8* %b.18, align 1, !dbg !363, !tbaa !350
  %36 = getelementptr inbounds i8* %a.17, i64 -1, !dbg !363
  store i8 %35, i8* %a.17, align 1, !dbg !363, !tbaa !350
  %37 = icmp eq i64 %33, 0, !dbg !363
  br i1 %37, label %.loopexit, label %scalar.ph211, !dbg !363, !llvm.loop !366
...
define weak i8* @mempcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #4 {
  %1 = icmp eq i64 %len, 0, !dbg !368
  br i1 %1, label %15, label %.lr.ph.preheader, !dbg !368
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %3 = bitcast i8* %next.gep to <16 x i8>*, !dbg !369
  %wide.load = load <16 x i8>* %3, align 1, !dbg !369
  %next.gep.sum280 = or i64 %index, 16, !dbg !369
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum280, !dbg !369
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !369
  %wide.load201 = load <16 x i8>* %5, align 1, !dbg !369
  %6 = bitcast i8* %next.gep104 to <16 x i8>*, !dbg !369
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !369
  %next.gep104.sum297 = or i64 %index, 16, !dbg !369
  %7 = getelementptr i8* %destaddr, i64 %next.gep104.sum297, !dbg !369
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !369
  store <16 x i8> %wide.load201, <16 x i8>* %8, align 1, !dbg !369
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
  br i1 %9, label %middle.block, label %vector.body, !llvm.loop !370
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %10 = add i64 %.01, -1, !dbg !368
  %11 = getelementptr inbounds i8* %src.03, i64 1, !dbg !369
  %12 = load i8* %src.03, align 1, !dbg !369, !tbaa !350
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !369
  store i8 %12, i8* %dest.02, align 1, !dbg !369, !tbaa !350
  %14 = icmp eq i64 %10, 0, !dbg !368
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !368, !llvm.loop !371
...
; <label>:15                                      ; preds = %._crit_edge, %0
  ...
  ret i8* %dest.0.lcssa, !dbg !372
}

; Function Attrs: nounwind uwtable
define weak i8* @memset(i8* %dst, i32 %s, i64 %count) #4 {
  %1 = icmp eq i64 %count, 0, !dbg !373
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !373

.lr.ph:                                           ; preds = %0
  %2 = trunc i32 %s to i8, !dbg !374
  br label %3, !dbg !373

; <label>:3                                       ; preds = %3, %.lr.ph
  %a.02 = phi i8* [ %dst, %.lr.ph ], [ %5, %3 ]
  %.01 = phi i64 [ %count, %.lr.ph ], [ %4, %3 ]
  %4 = add i64 %.01, -1, !dbg !373
  %5 = getelementptr inbounds i8* %a.02, i64 1, !dbg !374
  store volatile i8 %2, i8* %a.02, align 1, !dbg !374, !tbaa !350
  %6 = icmp eq i64 %4, 0, !dbg !373
  br i1 %6, label %._crit_edge, label %3, !dbg !373
...
define double @klee_internal_sqrt(double %d) #4 {
  %1 = tail call double @klee_sqrt_double(double %d) #12, !dbg !376
  ret double %1, !dbg !376
}
...
define float @klee_internal_sqrtf(float %f) #4 {
  %1 = tail call float @klee_sqrt_float(float %f) #12, !dbg !377
  ret float %1, !dbg !377
}
...
define x86_fp80 @klee_internal_sqrtl(x86_fp80 %f) #4 {
  %1 = tail call x86_fp80 @klee_sqrt_long_double(x86_fp80 %f) #12, !dbg !378
  ret x86_fp80 %1, !dbg !378
}
...
!1 = metadata !{metadata !"log-SYMBOLIC.c", metadata !"/home/fptesting/FPTesting/example"}
!2 = metadata !{i32 0}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/fptesting/FPTesting/example/log-SYMBOLIC.c]
...
!244 = metadata !{metadata !245, metadata !245, i64 0}
!245 = metadata !{metadata !"double", metadata !246, i64 0}
!246 = metadata !{metadata !"omnipotent char", metadata !247, i64 0}
!247 = metadata !{metadata !"Simple C/C++ TBAA"}
!248 = metadata !{metadata !249, metadata !249, i64 0}
!249 = metadata !{metadata !"long", metadata !246, i64 0}
!250 = metadata !{metadata !251, metadata !251, i64 0}
!251 = metadata !{metadata !"int", metadata !246, i64 0}
!252 = metadata !{i32 12, i32 0, metadata !12, null}
!253 = metadata !{i32 16, i32 0, metadata !19, null}
!254 = metadata !{i32 21, i32 0, metadata !25, null}
!255 = metadata !{i32 34, i32 0, metadata !51, null}
!256 = metadata !{i32 35, i32 0, metadata !51, null}
!257 = metadata !{i32 50, i32 0, metadata !51, null}
!258 = metadata !{i32 53, i32 0, metadata !55, null}
!259 = metadata !{i32 55, i32 0, metadata !260, null}
!260 = metadata !{i32 786443, metadata !32, metadata !55, i32 53, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fenv.c]
!261 = metadata !{i32 56, i32 0, metadata !260, null}
!262 = metadata !{i32 66, i32 0, metadata !260, null}
!263 = metadata !{i32 67, i32 0, metadata !260, null}
!264 = metadata !{i32 69, i32 0, metadata !260, null}
!265 = metadata !{i32 70, i32 0, metadata !260, null}
!266 = metadata !{i32 72, i32 0, metadata !260, null}
!267 = metadata !{i32 73, i32 0, metadata !260, null}
!268 = metadata !{i32 79, i32 0, metadata !55, null}
!269 = metadata !{i32 17, i32 0, metadata !71, null}
!270 = metadata !{i32 22, i32 0, metadata !77, null}
!271 = metadata !{i32 27, i32 0, metadata !82, null}
!272 = metadata !{i32 69, i32 0, metadata !273, null}
!273 = metadata !{i32 786443, metadata !61, metadata !87, i32 69, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!274 = metadata !{i32 71, i32 0, metadata !275, null}
!275 = metadata !{i32 786443, metadata !61, metadata !273, i32 71, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!276 = metadata !{i32 73, i32 0, metadata !277, null}
!277 = metadata !{i32 786443, metadata !61, metadata !275, i32 73, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!278 = metadata !{i32 75, i32 0, metadata !279, null}
!279 = metadata !{i32 786443, metadata !61, metadata !277, i32 75, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!280 = metadata !{i32 76, i32 0, metadata !281, null}
!281 = metadata !{i32 786443, metadata !61, metadata !279, i32 75, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!282 = metadata !{i32 79, i32 0, metadata !87, null}
!283 = metadata !{i32 84, i32 0, metadata !284, null}
!284 = metadata !{i32 786443, metadata !61, metadata !90, i32 84, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!285 = metadata !{i32 86, i32 0, metadata !286, null}
!286 = metadata !{i32 786443, metadata !61, metadata !284, i32 86, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!287 = metadata !{i32 88, i32 0, metadata !288, null}
!288 = metadata !{i32 786443, metadata !61, metadata !286, i32 88, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!289 = metadata !{i32 90, i32 0, metadata !290, null}
!290 = metadata !{i32 786443, metadata !61, metadata !288, i32 90, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!291 = metadata !{i32 91, i32 0, metadata !292, null}
!292 = metadata !{i32 786443, metadata !61, metadata !290, i32 90, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!293 = metadata !{i32 94, i32 0, metadata !90, null}
!294 = metadata !{i32 100, i32 0, metadata !295, null}
!295 = metadata !{i32 786443, metadata !61, metadata !93, i32 100, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!296 = metadata !{i32 102, i32 0, metadata !297, null}
!297 = metadata !{i32 786443, metadata !61, metadata !295, i32 102, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!298 = metadata !{i32 104, i32 0, metadata !299, null}
!299 = metadata !{i32 786443, metadata !61, metadata !297, i32 104, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!300 = metadata !{i32 106, i32 0, metadata !301, null}
!301 = metadata !{i32 786443, metadata !61, metadata !299, i32 106, i32 0, i32 22} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!302 = metadata !{i32 107, i32 0, metadata !303, null}
!303 = metadata !{i32 786443, metadata !61, metadata !301, i32 106, i32 0, i32 23} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!304 = metadata !{i32 110, i32 0, metadata !93, null}
!305 = metadata !{i32 115, i32 0, metadata !96, null}
!306 = metadata !{i32 120, i32 0, metadata !99, null}
!307 = metadata !{i32 125, i32 0, metadata !102, null}
!308 = metadata !{i32 13, i32 0, metadata !309, null}
!309 = metadata !{i32 786443, metadata !106, metadata !108, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/klee_div_zero_check.
!310 = metadata !{i32 14, i32 0, metadata !309, null}
!311 = metadata !{i32 15, i32 0, metadata !108, null}
!312 = metadata !{i32 15, i32 0, metadata !118, null}
!313 = metadata !{i32 16, i32 0, metadata !118, null}
!314 = metadata !{i32 21, i32 0, metadata !315, null}
!315 = metadata !{i32 786443, metadata !129, metadata !131, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/klee_overshift_check
!316 = metadata !{i32 27, i32 0, metadata !317, null}
!317 = metadata !{i32 786443, metadata !129, metadata !315, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/klee_overshift_check
!318 = metadata !{i32 29, i32 0, metadata !131, null}
!319 = metadata !{i32 16, i32 0, metadata !320, null}
!320 = metadata !{i32 786443, metadata !140, metadata !142, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/klee_range.c]
!321 = metadata !{i32 17, i32 0, metadata !320, null}
!322 = metadata !{i32 19, i32 0, metadata !323, null}
!323 = metadata !{i32 786443, metadata !140, metadata !142, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/klee_range.c]
!324 = metadata !{i32 22, i32 0, metadata !325, null}
!325 = metadata !{i32 786443, metadata !140, metadata !323, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/klee_range.c]
!326 = metadata !{i32 25, i32 0, metadata !327, null}
!327 = metadata !{i32 786443, metadata !140, metadata !325, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/klee_range.c]
!328 = metadata !{i32 26, i32 0, metadata !329, null}
!329 = metadata !{i32 786443, metadata !140, metadata !327, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/klee_range.c]
!330 = metadata !{i32 27, i32 0, metadata !329, null}
!331 = metadata !{i32 28, i32 0, metadata !332, null}
!332 = metadata !{i32 786443, metadata !140, metadata !327, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/klee_range.c]
!333 = metadata !{i32 29, i32 0, metadata !332, null}
!334 = metadata !{i32 32, i32 0, metadata !325, null}
!335 = metadata !{i32 34, i32 0, metadata !142, null}
!336 = metadata !{i32 19, i32 0, metadata !155, null}
!337 = metadata !{i32 21, i32 0, metadata !338, null}
!338 = metadata !{i32 786443, metadata !152, metadata !155, i32 19, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/klee_set_rounding_mo
!339 = metadata !{i32 23, i32 0, metadata !338, null}
!340 = metadata !{i32 25, i32 0, metadata !338, null}
!341 = metadata !{i32 27, i32 0, metadata !338, null}
!342 = metadata !{i32 29, i32 0, metadata !338, null}
!343 = metadata !{i32 31, i32 0, metadata !338, null}
!344 = metadata !{i32 33, i32 0, metadata !155, null}
!345 = metadata !{i32 16, i32 0, metadata !164, null}
!346 = metadata !{i32 17, i32 0, metadata !164, null}
!347 = metadata !{metadata !347, metadata !348, metadata !349}
!348 = metadata !{metadata !"llvm.vectorizer.width", i32 1}
!349 = metadata !{metadata !"llvm.vectorizer.unroll", i32 1}
!350 = metadata !{metadata !246, metadata !246, i64 0}
!351 = metadata !{metadata !351, metadata !348, metadata !349}
!352 = metadata !{i32 18, i32 0, metadata !164, null}
!353 = metadata !{i32 16, i32 0, metadata !354, null}
!354 = metadata !{i32 786443, metadata !181, metadata !183, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/memmove.c]
!355 = metadata !{i32 19, i32 0, metadata !356, null}
!356 = metadata !{i32 786443, metadata !181, metadata !183, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/memmove.c]
!357 = metadata !{i32 20, i32 0, metadata !358, null}
!358 = metadata !{i32 786443, metadata !181, metadata !356, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/memmove.c]
!359 = metadata !{metadata !359, metadata !348, metadata !349}
!360 = metadata !{metadata !360, metadata !348, metadata !349}
!361 = metadata !{i32 22, i32 0, metadata !362, null}
!362 = metadata !{i32 786443, metadata !181, metadata !356, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/memmove.c]
!363 = metadata !{i32 24, i32 0, metadata !362, null}
!364 = metadata !{i32 23, i32 0, metadata !362, null}
!365 = metadata !{metadata !365, metadata !348, metadata !349}
!366 = metadata !{metadata !366, metadata !348, metadata !349}
!367 = metadata !{i32 28, i32 0, metadata !183, null}
!368 = metadata !{i32 15, i32 0, metadata !197, null}
!369 = metadata !{i32 16, i32 0, metadata !197, null}
!370 = metadata !{metadata !370, metadata !348, metadata !349}
!371 = metadata !{metadata !371, metadata !348, metadata !349}
!372 = metadata !{i32 17, i32 0, metadata !197, null}
!373 = metadata !{i32 13, i32 0, metadata !211, null}
!374 = metadata !{i32 14, i32 0, metadata !211, null}
!375 = metadata !{i32 15, i32 0, metadata !211, null}
!376 = metadata !{i32 12, i32 0, metadata !226, null}
!377 = metadata !{i32 16, i32 0, metadata !230, null}
!378 = metadata !{i32 21, i32 0, metadata !233, null}
