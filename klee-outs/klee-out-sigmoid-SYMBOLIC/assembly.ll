; ModuleID = 'sigmoid-SYMBOLIC-internal.linked.bc'
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = bitcast float* %x to i8*, !dbg !239
  call void @klee_make_symbolic(i8* %2, i64 4, i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0)), !dbg !239
  %3 = load float* %x, align 4, !dbg !240
  %4 = fsub float -0.000000e+00, %3, !dbg !240
  %5 = call float @expf(float %4) #7, !dbg !240
  %6 = fadd float 1.000000e+00, %5, !dbg !240
  %7 = fdiv float 1.000000e+00, %6, !dbg !240
  store volatile float %7, float* %r, align 4, !dbg !240
  %8 = load volatile float* %r, align 4, !dbg !241
  %9 = fpext float %8 to double, !dbg !241
  %10 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i32 0, i32 0), double %9), !dbg !241
  ret i32 0, !dbg !242
}
...
; <label>:23                                      ; preds = %10
  ...
  %29 = load i64* %28, align 8, !tbaa !247
...
define void @cancel_injection(i8* nocapture readonly %psrc1, i8* nocapture readonly %psrc2, i8* nocapture readonly %pdest) #4 {
  ...
  %2 = load i64* %1, align 8, !tbaa !247
  %int_cast_to_i64 = bitcast i64 52 to i64
  call void @klee_overshift_check(i64 64, i64 %int_cast_to_i64)
  %3 = lshr i64 %2, 52
  %4 = and i64 %3, 2047
  %5 = bitcast i8* %psrc2 to i64*
  %6 = load i64* %5, align 8, !tbaa !247
  %int_cast_to_i641 = bitcast i64 52 to i64
  call void @klee_overshift_check(i64 64, i64 %int_cast_to_i641)
  %7 = lshr i64 %6, 52
  %8 = and i64 %7, 2047
  ...
  %14 = load i64* %13, align 8, !tbaa !247
...
define void @log_sampled_fp_injection(i8* nocapture readonly %psrc1, i8* nocapture readonly %psrc2, i8* nocapture readonly %pdest, i32* nocapture %pcounter, i32 %step, i32 %injection) #4 {
  %1 = load i32* %pcounter, align 4, !tbaa !249
  %2 = icmp eq i32 %1, 2147483647
  br i1 %2, label %round_injection.exit, label %3

; <label>:3                                       ; preds = %0
  %4 = add nsw i32 %1, 1
  store i32 %4, i32* %pcounter, align 4, !tbaa !249
  ...
  %10 = icmp eq i32 %9, 1
  %11 = load i32* %pcounter, align 4, !tbaa !249
...
; <label>:19                                      ; preds = %16
  ...
  %21 = load i64* %20, align 8, !tbaa !247
  %int_cast_to_i642 = bitcast i64 52 to i64
  call void @klee_overshift_check(i64 64, i64 %int_cast_to_i642)
  %22 = lshr i64 %21, 52
  %23 = and i64 %22, 2047
  %24 = bitcast i8* %psrc2 to i64*
  %25 = load i64* %24, align 8, !tbaa !247
  %int_cast_to_i643 = bitcast i64 52 to i64
  call void @klee_overshift_check(i64 64, i64 %int_cast_to_i643)
  %26 = lshr i64 %25, 52
  %27 = and i64 %26, 2047
...
; <label>:10                                      ; preds = %7
  ...
  %12 = load i64* %11, align 8, !tbaa !247
  %int_cast_to_i641 = bitcast i64 52 to i64
  call void @klee_overshift_check(i64 64, i64 %int_cast_to_i641)
  %13 = lshr i64 %12, 52
  %14 = and i64 %13, 2047
  %15 = bitcast i8* %psrc2 to i64*
  %16 = load i64* %15, align 8, !tbaa !247
  %int_cast_to_i642 = bitcast i64 52 to i64
  call void @klee_overshift_check(i64 64, i64 %int_cast_to_i642)
  %17 = lshr i64 %16, 52
  %18 = and i64 %17, 2047
...
define double @klee_internal_fabs(double %d) #4 {
  %1 = tail call double @klee_abs_double(double %d) #12, !dbg !251
  ret double %1, !dbg !251
}
...
define float @klee_internal_fabsf(float %f) #4 {
  %1 = tail call float @klee_abs_float(float %f) #12, !dbg !252
  ret float %1, !dbg !252
}
...
define x86_fp80 @klee_internal_fabsl(x86_fp80 %f) #4 {
  %1 = tail call x86_fp80 @klee_abs_long_double(x86_fp80 %f) #12, !dbg !253
  ret x86_fp80 %1, !dbg !253
}
...
define i32 @klee_internal_fegetround() #4 {
  %1 = tail call i32 (...)* @klee_get_rounding_mode() #12, !dbg !254
  %2 = icmp ult i32 %1, 5, !dbg !255
  br i1 %2, label %switch.lookup, label %4, !dbg !255

switch.lookup:                                    ; preds = %0
  %3 = sext i32 %1 to i64, !dbg !255
  %switch.gep = getelementptr inbounds [5 x i32]* @switch.table, i64 0, i64 %3, !dbg !255
  %switch.load = load i32* %switch.gep, align 4, !dbg !255
  ret i32 %switch.load, !dbg !255
...
; <label>:1                                       ; preds = %0
  tail call void @klee_set_rounding_mode(i32 0) #12, !dbg !258
  br label %5, !dbg !260

; <label>:2                                       ; preds = %0
  tail call void @klee_set_rounding_mode(i32 2) #12, !dbg !261
  br label %5, !dbg !262

; <label>:3                                       ; preds = %0
  tail call void @klee_set_rounding_mode(i32 3) #12, !dbg !263
  br label %5, !dbg !264

; <label>:4                                       ; preds = %0
  tail call void @klee_set_rounding_mode(i32 4) #12, !dbg !265
  br label %5, !dbg !266
...
define i32 @klee_internal_isnanf(float %f) #4 {
  %1 = tail call zeroext i1 @klee_is_nan_float(float %f) #12, !dbg !268
  %2 = zext i1 %1 to i32, !dbg !268
  ret i32 %2, !dbg !268
}
...
define i32 @klee_internal_isnan(double %d) #4 {
  %1 = tail call zeroext i1 @klee_is_nan_double(double %d) #12, !dbg !269
  %2 = zext i1 %1 to i32, !dbg !269
  ret i32 %2, !dbg !269
}
...
define i32 @klee_internal_isnanl(x86_fp80 %d) #4 {
  %1 = tail call zeroext i1 @klee_is_nan_long_double(x86_fp80 %d) #12, !dbg !270
...
define i32 @klee_internal_fpclassifyf(float %f) #4 {
  %1 = tail call zeroext i1 @klee_is_nan_float(float %f) #12, !dbg !271
  br i1 %1, label %8, label %2, !dbg !271

; <label>:2                                       ; preds = %0
  %3 = tail call zeroext i1 @klee_is_infinite_float(float %f) #12, !dbg !273
  br i1 %3, label %8, label %4, !dbg !273

; <label>:4                                       ; preds = %2
  %5 = fcmp oeq float %f, 0.000000e+00, !dbg !275
  br i1 %5, label %8, label %6, !dbg !275

; <label>:6                                       ; preds = %4
  %7 = tail call zeroext i1 @klee_is_normal_float(float %f) #12, !dbg !277
  %. = select i1 %7, i32 4, i32 3, !dbg !279
  br label %8, !dbg !279
...
define i32 @klee_internal_fpclassify(double %f) #4 {
  %1 = tail call zeroext i1 @klee_is_nan_double(double %f) #12, !dbg !282
  br i1 %1, label %8, label %2, !dbg !282

; <label>:2                                       ; preds = %0
  %3 = tail call zeroext i1 @klee_is_infinite_double(double %f) #12, !dbg !284
  br i1 %3, label %8, label %4, !dbg !284

; <label>:4                                       ; preds = %2
  %5 = fcmp oeq double %f, 0.000000e+00, !dbg !286
  br i1 %5, label %8, label %6, !dbg !286

; <label>:6                                       ; preds = %4
  %7 = tail call zeroext i1 @klee_is_normal_double(double %f) #12, !dbg !288
...
define i32 @klee_internal_fpclassifyl(x86_fp80 %ld) #4 {
  %1 = tail call zeroext i1 @klee_is_nan_long_double(x86_fp80 %ld) #12, !dbg !293
  br i1 %1, label %8, label %2, !dbg !293

; <label>:2                                       ; preds = %0
  %3 = tail call zeroext i1 @klee_is_infinite_long_double(x86_fp80 %ld) #12, !dbg !295
  br i1 %3, label %8, label %4, !dbg !295

; <label>:4                                       ; preds = %2
  %5 = fcmp oeq x86_fp80 %ld, 0xK00000000000000000000, !dbg !297
  br i1 %5, label %8, label %6, !dbg !297

; <label>:6                                       ; preds = %4
  %7 = tail call zeroext i1 @klee_is_normal_long_double(x86_fp80 %ld) #12, !dbg !299
...
define i32 @klee_internal_finitef(float %f) #4 {
  %1 = tail call zeroext i1 @klee_is_nan_float(float %f) #12, !dbg !304
  %2 = zext i1 %1 to i32, !dbg !304
  %3 = xor i32 %2, 1, !dbg !304
  %4 = tail call zeroext i1 @klee_is_infinite_float(float %f) #12, !dbg !304
  %5 = zext i1 %4 to i32, !dbg !304
  %6 = xor i32 %5, 1, !dbg !304
  %7 = and i32 %6, %3, !dbg !304
  ret i32 %7, !dbg !304
}

; Function Attrs: nounwind uwtable
define i32 @klee_internal_finite(double %f) #4 {
  %1 = tail call zeroext i1 @klee_is_nan_double(double %f) #12, !dbg !305
  %2 = zext i1 %1 to i32, !dbg !305
  %3 = xor i32 %2, 1, !dbg !305
  %4 = tail call zeroext i1 @klee_is_infinite_double(double %f) #12, !dbg !305
  %5 = zext i1 %4 to i32, !dbg !305
  %6 = xor i32 %5, 1, !dbg !305
  %7 = and i32 %6, %3, !dbg !305
  ret i32 %7, !dbg !305
}

; Function Attrs: nounwind uwtable
define i32 @klee_internal_finitel(x86_fp80 %f) #4 {
  %1 = tail call zeroext i1 @klee_is_nan_long_double(x86_fp80 %f) #12, !dbg !306
  %2 = zext i1 %1 to i32, !dbg !306
  %3 = xor i32 %2, 1, !dbg !306
  %4 = tail call zeroext i1 @klee_is_infinite_long_double(x86_fp80 %f) #12, !dbg !306
...
define void @klee_div_zero_check(i64 %z) #4 {
  %1 = icmp eq i64 %z, 0, !dbg !307
  br i1 %1, label %2, label %3, !dbg !307

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([81 x i8]* @.str2, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str13, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str24, i64 0, i64 0)) #13, !dbg !309
  unreachable, !dbg !309
...
define i32 @klee_int(i8* %name) #4 {
  ...
  %1 = bitcast i32* %x to i8*, !dbg !311
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #12, !dbg !311
  %2 = load i32* %x, align 4, !dbg !312, !tbaa !249
  ret i32 %2, !dbg !312
}

; Function Attrs: nounwind uwtable
define void @klee_overshift_check(i64 %bitWidth, i64 %shift) #4 {
  %1 = icmp ult i64 %shift, %bitWidth, !dbg !313
  br i1 %1, label %3, label %2, !dbg !313

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #13, !dbg !315
  unreachable, !dbg !315
...
define i32 @klee_range(i32 %start, i32 %end, i8* %name) #4 {
  %x = alloca i32, align 4
  %1 = icmp slt i32 %start, %end, !dbg !318
  br i1 %1, label %3, label %2, !dbg !318

; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([72 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #13, !dbg !320
  unreachable, !dbg !320

; <label>:3                                       ; preds = %0
  %4 = add nsw i32 %start, 1, !dbg !321
  %5 = icmp eq i32 %4, %end, !dbg !321
  br i1 %5, label %21, label %6, !dbg !321

; <label>:6                                       ; preds = %3
  %7 = bitcast i32* %x to i8*, !dbg !323
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #12, !dbg !323
  %8 = icmp eq i32 %start, 0, !dbg !325
  %9 = load i32* %x, align 4, !dbg !327, !tbaa !249
  br i1 %8, label %10, label %13, !dbg !325

; <label>:10                                      ; preds = %6
  %11 = icmp ult i32 %9, %end, !dbg !327
  %12 = zext i1 %11 to i64, !dbg !327
  call void @klee_assume(i64 %12) #12, !dbg !327
  br label %19, !dbg !329

; <label>:13                                      ; preds = %6
  %14 = icmp sge i32 %9, %start, !dbg !330
  %15 = zext i1 %14 to i64, !dbg !330
  call void @klee_assume(i64 %15) #12, !dbg !330
  %16 = load i32* %x, align 4, !dbg !332, !tbaa !249
  %17 = icmp slt i32 %16, %end, !dbg !332
  %18 = zext i1 %17 to i64, !dbg !332
  call void @klee_assume(i64 %18) #12, !dbg !332
  br label %19

; <label>:19                                      ; preds = %13, %10
  %20 = load i32* %x, align 4, !dbg !333, !tbaa !249
  br label %21, !dbg !333
...
; <label>:1                                       ; preds = %0
  tail call void @klee_set_rounding_mode_internal(i32 0) #12, !dbg !336
  br label %7, !dbg !336

; <label>:2                                       ; preds = %0
  tail call void @klee_set_rounding_mode_internal(i32 1) #12, !dbg !338
  br label %7, !dbg !338

; <label>:3                                       ; preds = %0
  tail call void @klee_set_rounding_mode_internal(i32 2) #12, !dbg !339
  br label %7, !dbg !339

; <label>:4                                       ; preds = %0
  tail call void @klee_set_rounding_mode_internal(i32 3) #12, !dbg !340
  br label %7, !dbg !340

; <label>:5                                       ; preds = %0
  tail call void @klee_set_rounding_mode_internal(i32 4) #12, !dbg !341
  br label %7, !dbg !341

; <label>:6                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([84 x i8]* @.str9, i64 0, i64 0), i32 31, i8* getelementptr inbounds ([22 x i8]* @.str110, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str211, i64 0, i64 0)) #13, !dbg !342
  unreachable, !dbg !342
...
define weak i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #4 {
  %1 = icmp eq i64 %len, 0, !dbg !344
  br i1 %1, label %._crit_edge, label %.lr.ph.preheader, !dbg !344
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %3 = bitcast i8* %next.gep to <16 x i8>*, !dbg !345
  %wide.load = load <16 x i8>* %3, align 1, !dbg !345
  %next.gep.sum279 = or i64 %index, 16, !dbg !345
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum279, !dbg !345
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !345
  %wide.load200 = load <16 x i8>* %5, align 1, !dbg !345
  %6 = bitcast i8* %next.gep103 to <16 x i8>*, !dbg !345
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !345
  %next.gep103.sum296 = or i64 %index, 16, !dbg !345
  %7 = getelementptr i8* %destaddr, i64 %next.gep103.sum296, !dbg !345
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !345
  store <16 x i8> %wide.load200, <16 x i8>* %8, align 1, !dbg !345
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
  br i1 %9, label %middle.block, label %vector.body, !llvm.loop !346
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %10 = add i64 %.01, -1, !dbg !344
  %11 = getelementptr inbounds i8* %src.03, i64 1, !dbg !345
  %12 = load i8* %src.03, align 1, !dbg !345, !tbaa !349
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !345
  store i8 %12, i8* %dest.02, align 1, !dbg !345, !tbaa !349
  %14 = icmp eq i64 %10, 0, !dbg !344
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !344, !llvm.loop !350

._crit_edge:                                      ; preds = %.lr.ph, %middle.block, %0
  ret i8* %destaddr, !dbg !351
}

; Function Attrs: nounwind uwtable
define weak i8* @memmove(i8* %dst, i8* %src, i64 %count) #4 {
  %1 = icmp eq i8* %src, %dst, !dbg !352
  br i1 %1, label %.loopexit, label %2, !dbg !352

; <label>:2                                       ; preds = %0
  %3 = icmp ugt i8* %src, %dst, !dbg !354
  br i1 %3, label %.preheader, label %18, !dbg !354

.preheader:                                       ; preds = %2
  %4 = icmp eq i64 %count, 0, !dbg !356
  br i1 %4, label %.loopexit, label %.lr.ph.preheader, !dbg !356
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %6 = bitcast i8* %next.gep to <16 x i8>*, !dbg !356
  %wide.load = load <16 x i8>* %6, align 1, !dbg !356
  %next.gep.sum586 = or i64 %index, 16, !dbg !356
  %7 = getelementptr i8* %src, i64 %next.gep.sum586, !dbg !356
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !356
  %wide.load207 = load <16 x i8>* %8, align 1, !dbg !356
  %9 = bitcast i8* %next.gep110 to <16 x i8>*, !dbg !356
  store <16 x i8> %wide.load, <16 x i8>* %9, align 1, !dbg !356
  %next.gep110.sum603 = or i64 %index, 16, !dbg !356
  %10 = getelementptr i8* %dst, i64 %next.gep110.sum603, !dbg !356
  %11 = bitcast i8* %10 to <16 x i8>*, !dbg !356
  store <16 x i8> %wide.load207, <16 x i8>* %11, align 1, !dbg !356
  %index.next = add i64 %index, 32
  %12 = icmp eq i64 %index.next, %n.vec
  br i1 %12, label %middle.block, label %vector.body, !llvm.loop !358
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %13 = add i64 %.02, -1, !dbg !356
  %14 = getelementptr inbounds i8* %b.04, i64 1, !dbg !356
  %15 = load i8* %b.04, align 1, !dbg !356, !tbaa !349
  %16 = getelementptr inbounds i8* %a.03, i64 1, !dbg !356
  store i8 %15, i8* %a.03, align 1, !dbg !356, !tbaa !349
  %17 = icmp eq i64 %13, 0, !dbg !356
  br i1 %17, label %.loopexit, label %.lr.ph, !dbg !356, !llvm.loop !359

; <label>:18                                      ; preds = %2
  %19 = add i64 %count, -1, !dbg !360
  %20 = icmp eq i64 %count, 0, !dbg !362
  br i1 %20, label %.loopexit, label %.lr.ph9, !dbg !362

.lr.ph9:                                          ; preds = %18
  %21 = getelementptr inbounds i8* %src, i64 %19, !dbg !363
  %22 = getelementptr inbounds i8* %dst, i64 %19, !dbg !360
...
vector.body209:                                   ; preds = %vector.body209, %vector.memcheck224
  ...
  %next.gep236.sum = add i64 %.sum440, -15, !dbg !362
  %24 = getelementptr i8* %src, i64 %next.gep236.sum, !dbg !362
  %25 = bitcast i8* %24 to <16 x i8>*, !dbg !362
  %wide.load434 = load <16 x i8>* %25, align 1, !dbg !362
  %reverse = shufflevector <16 x i8> %wide.load434, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !362
  %.sum505 = add i64 %.sum440, -31, !dbg !362
  %26 = getelementptr i8* %src, i64 %.sum505, !dbg !362
  %27 = bitcast i8* %26 to <16 x i8>*, !dbg !362
  %wide.load435 = load <16 x i8>* %27, align 1, !dbg !362
  %reverse436 = shufflevector <16 x i8> %wide.load435, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !362
  %reverse437 = shufflevector <16 x i8> %reverse, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !362
  %next.gep333.sum = add i64 %.sum472, -15, !dbg !362
  %28 = getelementptr i8* %dst, i64 %next.gep333.sum, !dbg !362
  %29 = bitcast i8* %28 to <16 x i8>*, !dbg !362
  store <16 x i8> %reverse437, <16 x i8>* %29, align 1, !dbg !362
  %reverse438 = shufflevector <16 x i8> %reverse436, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !362
  %.sum507 = add i64 %.sum472, -31, !dbg !362
  %30 = getelementptr i8* %dst, i64 %.sum507, !dbg !362
  %31 = bitcast i8* %30 to <16 x i8>*, !dbg !362
  store <16 x i8> %reverse438, <16 x i8>* %31, align 1, !dbg !362
  %index.next234 = add i64 %index212, 32
  %32 = icmp eq i64 %index.next234, %n.vec215
  br i1 %32, label %middle.block210, label %vector.body209, !llvm.loop !364
...
scalar.ph211:                                     ; preds = %scalar.ph211, %middle.block210
  ...
  %33 = add i64 %.16, -1, !dbg !362
  %34 = getelementptr inbounds i8* %b.18, i64 -1, !dbg !362
  %35 = load i8* %b.18, align 1, !dbg !362, !tbaa !349
  %36 = getelementptr inbounds i8* %a.17, i64 -1, !dbg !362
  store i8 %35, i8* %a.17, align 1, !dbg !362, !tbaa !349
  %37 = icmp eq i64 %33, 0, !dbg !362
  br i1 %37, label %.loopexit, label %scalar.ph211, !dbg !362, !llvm.loop !365
...
define weak i8* @mempcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #4 {
  %1 = icmp eq i64 %len, 0, !dbg !367
  br i1 %1, label %15, label %.lr.ph.preheader, !dbg !367
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %3 = bitcast i8* %next.gep to <16 x i8>*, !dbg !368
  %wide.load = load <16 x i8>* %3, align 1, !dbg !368
  %next.gep.sum280 = or i64 %index, 16, !dbg !368
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum280, !dbg !368
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !368
  %wide.load201 = load <16 x i8>* %5, align 1, !dbg !368
  %6 = bitcast i8* %next.gep104 to <16 x i8>*, !dbg !368
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !368
  %next.gep104.sum297 = or i64 %index, 16, !dbg !368
  %7 = getelementptr i8* %destaddr, i64 %next.gep104.sum297, !dbg !368
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !368
  store <16 x i8> %wide.load201, <16 x i8>* %8, align 1, !dbg !368
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
  br i1 %9, label %middle.block, label %vector.body, !llvm.loop !369
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %10 = add i64 %.01, -1, !dbg !367
  %11 = getelementptr inbounds i8* %src.03, i64 1, !dbg !368
  %12 = load i8* %src.03, align 1, !dbg !368, !tbaa !349
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !368
  store i8 %12, i8* %dest.02, align 1, !dbg !368, !tbaa !349
  %14 = icmp eq i64 %10, 0, !dbg !367
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !367, !llvm.loop !370
...
; <label>:15                                      ; preds = %._crit_edge, %0
  ...
  ret i8* %dest.0.lcssa, !dbg !371
}

; Function Attrs: nounwind uwtable
define weak i8* @memset(i8* %dst, i32 %s, i64 %count) #4 {
  %1 = icmp eq i64 %count, 0, !dbg !372
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !372

.lr.ph:                                           ; preds = %0
  %2 = trunc i32 %s to i8, !dbg !373
  br label %3, !dbg !372

; <label>:3                                       ; preds = %3, %.lr.ph
  %a.02 = phi i8* [ %dst, %.lr.ph ], [ %5, %3 ]
  %.01 = phi i64 [ %count, %.lr.ph ], [ %4, %3 ]
  %4 = add i64 %.01, -1, !dbg !372
  %5 = getelementptr inbounds i8* %a.02, i64 1, !dbg !373
  store volatile i8 %2, i8* %a.02, align 1, !dbg !373, !tbaa !349
  %6 = icmp eq i64 %4, 0, !dbg !372
  br i1 %6, label %._crit_edge, label %3, !dbg !372
...
define double @klee_internal_sqrt(double %d) #4 {
  %1 = tail call double @klee_sqrt_double(double %d) #12, !dbg !375
  ret double %1, !dbg !375
}
...
define float @klee_internal_sqrtf(float %f) #4 {
  %1 = tail call float @klee_sqrt_float(float %f) #12, !dbg !376
  ret float %1, !dbg !376
}
...
define x86_fp80 @klee_internal_sqrtl(x86_fp80 %f) #4 {
  %1 = tail call x86_fp80 @klee_sqrt_long_double(x86_fp80 %f) #12, !dbg !377
  ret x86_fp80 %1, !dbg !377
}
...
!1 = metadata !{metadata !"sigmoid-SYMBOLIC.c", metadata !"/home/fptesting/FPTesting/example"}
!2 = metadata !{i32 0}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/fptesting/FPTesting/example/sigmoid-SYMBOLIC.c]
...
!247 = metadata !{metadata !248, metadata !248, i64 0}
!248 = metadata !{metadata !"long", metadata !245, i64 0}
!249 = metadata !{metadata !250, metadata !250, i64 0}
!250 = metadata !{metadata !"int", metadata !245, i64 0}
!251 = metadata !{i32 12, i32 0, metadata !12, null}
!252 = metadata !{i32 16, i32 0, metadata !19, null}
!253 = metadata !{i32 21, i32 0, metadata !25, null}
!254 = metadata !{i32 34, i32 0, metadata !51, null}
!255 = metadata !{i32 35, i32 0, metadata !51, null}
!256 = metadata !{i32 50, i32 0, metadata !51, null}
!257 = metadata !{i32 53, i32 0, metadata !55, null}
!258 = metadata !{i32 55, i32 0, metadata !259, null}
!259 = metadata !{i32 786443, metadata !32, metadata !55, i32 53, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fenv.c]
!260 = metadata !{i32 56, i32 0, metadata !259, null}
!261 = metadata !{i32 66, i32 0, metadata !259, null}
!262 = metadata !{i32 67, i32 0, metadata !259, null}
!263 = metadata !{i32 69, i32 0, metadata !259, null}
!264 = metadata !{i32 70, i32 0, metadata !259, null}
!265 = metadata !{i32 72, i32 0, metadata !259, null}
!266 = metadata !{i32 73, i32 0, metadata !259, null}
!267 = metadata !{i32 79, i32 0, metadata !55, null}
!268 = metadata !{i32 17, i32 0, metadata !71, null}
!269 = metadata !{i32 22, i32 0, metadata !77, null}
!270 = metadata !{i32 27, i32 0, metadata !82, null}
!271 = metadata !{i32 69, i32 0, metadata !272, null}
!272 = metadata !{i32 786443, metadata !61, metadata !87, i32 69, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!273 = metadata !{i32 71, i32 0, metadata !274, null}
!274 = metadata !{i32 786443, metadata !61, metadata !272, i32 71, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!275 = metadata !{i32 73, i32 0, metadata !276, null}
!276 = metadata !{i32 786443, metadata !61, metadata !274, i32 73, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!277 = metadata !{i32 75, i32 0, metadata !278, null}
!278 = metadata !{i32 786443, metadata !61, metadata !276, i32 75, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!279 = metadata !{i32 76, i32 0, metadata !280, null}
!280 = metadata !{i32 786443, metadata !61, metadata !278, i32 75, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!281 = metadata !{i32 79, i32 0, metadata !87, null}
!282 = metadata !{i32 84, i32 0, metadata !283, null}
!283 = metadata !{i32 786443, metadata !61, metadata !90, i32 84, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!284 = metadata !{i32 86, i32 0, metadata !285, null}
!285 = metadata !{i32 786443, metadata !61, metadata !283, i32 86, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!286 = metadata !{i32 88, i32 0, metadata !287, null}
!287 = metadata !{i32 786443, metadata !61, metadata !285, i32 88, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!288 = metadata !{i32 90, i32 0, metadata !289, null}
!289 = metadata !{i32 786443, metadata !61, metadata !287, i32 90, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!290 = metadata !{i32 91, i32 0, metadata !291, null}
!291 = metadata !{i32 786443, metadata !61, metadata !289, i32 90, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!292 = metadata !{i32 94, i32 0, metadata !90, null}
!293 = metadata !{i32 100, i32 0, metadata !294, null}
!294 = metadata !{i32 786443, metadata !61, metadata !93, i32 100, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!295 = metadata !{i32 102, i32 0, metadata !296, null}
!296 = metadata !{i32 786443, metadata !61, metadata !294, i32 102, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!297 = metadata !{i32 104, i32 0, metadata !298, null}
!298 = metadata !{i32 786443, metadata !61, metadata !296, i32 104, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!299 = metadata !{i32 106, i32 0, metadata !300, null}
!300 = metadata !{i32 786443, metadata !61, metadata !298, i32 106, i32 0, i32 22} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!301 = metadata !{i32 107, i32 0, metadata !302, null}
!302 = metadata !{i32 786443, metadata !61, metadata !300, i32 106, i32 0, i32 23} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/fpclassify.c]
!303 = metadata !{i32 110, i32 0, metadata !93, null}
!304 = metadata !{i32 115, i32 0, metadata !96, null}
!305 = metadata !{i32 120, i32 0, metadata !99, null}
!306 = metadata !{i32 125, i32 0, metadata !102, null}
!307 = metadata !{i32 13, i32 0, metadata !308, null}
!308 = metadata !{i32 786443, metadata !106, metadata !108, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/klee_div_zero_check.
!309 = metadata !{i32 14, i32 0, metadata !308, null}
!310 = metadata !{i32 15, i32 0, metadata !108, null}
!311 = metadata !{i32 15, i32 0, metadata !118, null}
!312 = metadata !{i32 16, i32 0, metadata !118, null}
!313 = metadata !{i32 21, i32 0, metadata !314, null}
!314 = metadata !{i32 786443, metadata !129, metadata !131, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/klee_overshift_check
!315 = metadata !{i32 27, i32 0, metadata !316, null}
!316 = metadata !{i32 786443, metadata !129, metadata !314, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/klee_overshift_check
!317 = metadata !{i32 29, i32 0, metadata !131, null}
!318 = metadata !{i32 16, i32 0, metadata !319, null}
!319 = metadata !{i32 786443, metadata !140, metadata !142, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/klee_range.c]
!320 = metadata !{i32 17, i32 0, metadata !319, null}
!321 = metadata !{i32 19, i32 0, metadata !322, null}
!322 = metadata !{i32 786443, metadata !140, metadata !142, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/klee_range.c]
!323 = metadata !{i32 22, i32 0, metadata !324, null}
!324 = metadata !{i32 786443, metadata !140, metadata !322, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/klee_range.c]
!325 = metadata !{i32 25, i32 0, metadata !326, null}
!326 = metadata !{i32 786443, metadata !140, metadata !324, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/klee_range.c]
!327 = metadata !{i32 26, i32 0, metadata !328, null}
!328 = metadata !{i32 786443, metadata !140, metadata !326, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/klee_range.c]
!329 = metadata !{i32 27, i32 0, metadata !328, null}
!330 = metadata !{i32 28, i32 0, metadata !331, null}
!331 = metadata !{i32 786443, metadata !140, metadata !326, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/klee_range.c]
!332 = metadata !{i32 29, i32 0, metadata !331, null}
!333 = metadata !{i32 32, i32 0, metadata !324, null}
!334 = metadata !{i32 34, i32 0, metadata !142, null}
!335 = metadata !{i32 19, i32 0, metadata !155, null}
!336 = metadata !{i32 21, i32 0, metadata !337, null}
!337 = metadata !{i32 786443, metadata !152, metadata !155, i32 19, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/klee_set_rounding_mo
!338 = metadata !{i32 23, i32 0, metadata !337, null}
!339 = metadata !{i32 25, i32 0, metadata !337, null}
!340 = metadata !{i32 27, i32 0, metadata !337, null}
!341 = metadata !{i32 29, i32 0, metadata !337, null}
!342 = metadata !{i32 31, i32 0, metadata !337, null}
!343 = metadata !{i32 33, i32 0, metadata !155, null}
!344 = metadata !{i32 16, i32 0, metadata !164, null}
!345 = metadata !{i32 17, i32 0, metadata !164, null}
!346 = metadata !{metadata !346, metadata !347, metadata !348}
!347 = metadata !{metadata !"llvm.vectorizer.width", i32 1}
!348 = metadata !{metadata !"llvm.vectorizer.unroll", i32 1}
!349 = metadata !{metadata !245, metadata !245, i64 0}
!350 = metadata !{metadata !350, metadata !347, metadata !348}
!351 = metadata !{i32 18, i32 0, metadata !164, null}
!352 = metadata !{i32 16, i32 0, metadata !353, null}
!353 = metadata !{i32 786443, metadata !181, metadata !183, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/memmove.c]
!354 = metadata !{i32 19, i32 0, metadata !355, null}
!355 = metadata !{i32 786443, metadata !181, metadata !183, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/memmove.c]
!356 = metadata !{i32 20, i32 0, metadata !357, null}
!357 = metadata !{i32 786443, metadata !181, metadata !355, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/memmove.c]
!358 = metadata !{metadata !358, metadata !347, metadata !348}
!359 = metadata !{metadata !359, metadata !347, metadata !348}
!360 = metadata !{i32 22, i32 0, metadata !361, null}
!361 = metadata !{i32 786443, metadata !181, metadata !355, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/fptesting/FPTesting/src/klee-float/build/runtime/Intrinsic//home/fptesting/FPTesting/src/klee-float/runtime/Intrinsic/memmove.c]
!362 = metadata !{i32 24, i32 0, metadata !361, null}
!363 = metadata !{i32 23, i32 0, metadata !361, null}
!364 = metadata !{metadata !364, metadata !347, metadata !348}
!365 = metadata !{metadata !365, metadata !347, metadata !348}
!366 = metadata !{i32 28, i32 0, metadata !183, null}
!367 = metadata !{i32 15, i32 0, metadata !197, null}
!368 = metadata !{i32 16, i32 0, metadata !197, null}
!369 = metadata !{metadata !369, metadata !347, metadata !348}
!370 = metadata !{metadata !370, metadata !347, metadata !348}
!371 = metadata !{i32 17, i32 0, metadata !197, null}
!372 = metadata !{i32 13, i32 0, metadata !211, null}
!373 = metadata !{i32 14, i32 0, metadata !211, null}
!374 = metadata !{i32 15, i32 0, metadata !211, null}
!375 = metadata !{i32 12, i32 0, metadata !226, null}
!376 = metadata !{i32 16, i32 0, metadata !230, null}
!377 = metadata !{i32 21, i32 0, metadata !233, null}
