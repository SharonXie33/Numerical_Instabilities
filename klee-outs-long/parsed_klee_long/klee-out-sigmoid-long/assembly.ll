; ModuleID = 'sigmoid-long.linked.bc'
...
define i32 @main() #0 {
  ...
  store volatile float %7, float* %r, align 4
  %8 = load volatile float* %r, align 4
  %9 = fpext float %8 to double
  %10 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i32 0, i32 0), double %9)
  ret i32 0
}
