...
define i32 @main() #0 {
  ...
  store volatile float %5, float* %x, align 4
  %6 = getelementptr inbounds [2 x float]* %in, i32 0, i64 1
  %7 = load float* %6, align 4
  store volatile float %7, float* %y, align 4
  %8 = load volatile float* %x, align 4
  %9 = load volatile float* %y, align 4
  %10 = call float @powf(float %8, float %9) #6
