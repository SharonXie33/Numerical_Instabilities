; ModuleID = 'div-SYMBOLIC-internal.linked.bc'
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = getelementptr inbounds [2 x float]* %input, i32 0, i32 0, !dbg !239
  ...
  %4 = getelementptr inbounds [2 x float]* %input, i32 0, i64 0, !dbg !240
  %5 = load float* %4, align 4, !dbg !240
  store volatile float %5, float* %a, align 4, !dbg !240
  %6 = getelementptr inbounds [2 x float]* %input, i32 0, i64 1, !dbg !241
  %7 = load float* %6, align 4, !dbg !241
  store volatile float %7, float* %b, align 4, !dbg !241
  %8 = load volatile float* %a, align 4, !dbg !242
  %9 = load volatile float* %b, align 4, !dbg !242
  %10 = fdiv float %8, %9, !dbg !242
...
define double @klee_internal_fabs(double %d) #3 {
  %1 = tail call double @klee_abs_double(double %d) #11, !dbg !253
...
define float @klee_internal_fabsf(float %f) #3 {
  %1 = tail call float @klee_abs_float(float %f) #11, !dbg !254
  ret float %1, !dbg !254
}
...
define x86_fp80 @klee_internal_fabsl(x86_fp80 %f) #3 {
  %1 = tail call x86_fp80 @klee_abs_long_double(x86_fp80 %f) #11, !dbg !255
...
define i32 @klee_internal_fegetround() #3 {
  %1 = tail call i32 (...)* @klee_get_rounding_mode() #11, !dbg !256
...
; <label>:1                                       ; preds = %0
  tail call void @klee_set_rounding_mode(i32 0) #11, !dbg !260
  br label %5, !dbg !262

; <label>:2                                       ; preds = %0
  tail call void @klee_set_rounding_mode(i32 2) #11, !dbg !263
  br label %5, !dbg !264

; <label>:3                                       ; preds = %0
  tail call void @klee_set_rounding_mode(i32 3) #11, !dbg !265
  br label %5, !dbg !266

; <label>:4                                       ; preds = %0
  tail call void @klee_set_rounding_mode(i32 4) #11, !dbg !267
  br label %5, !dbg !268
...
define i32 @klee_internal_isnanf(float %f) #3 {
  %1 = tail call zeroext i1 @klee_is_nan_float(float %f) #11, !dbg !270
...
define i32 @klee_internal_isnan(double %d) #3 {
  %1 = tail call zeroext i1 @klee_is_nan_double(double %d) #11, !dbg !271
...
define i32 @klee_internal_isnanl(x86_fp80 %d) #3 {
  %1 = tail call zeroext i1 @klee_is_nan_long_double(x86_fp80 %d) #11, !dbg !272
...
define i32 @klee_internal_fpclassifyf(float %f) #3 {
  %1 = tail call zeroext i1 @klee_is_nan_float(float %f) #11, !dbg !273
  br i1 %1, label %8, label %2, !dbg !273

; <label>:2                                       ; preds = %0
  %3 = tail call zeroext i1 @klee_is_infinite_float(float %f) #11, !dbg !275
...
; <label>:6                                       ; preds = %4
  %7 = tail call zeroext i1 @klee_is_normal_float(float %f) #11, !dbg !279
...
define i32 @klee_internal_fpclassify(double %f) #3 {
  %1 = tail call zeroext i1 @klee_is_nan_double(double %f) #11, !dbg !284
  br i1 %1, label %8, label %2, !dbg !284

; <label>:2                                       ; preds = %0
  %3 = tail call zeroext i1 @klee_is_infinite_double(double %f) #11, !dbg !286
...
; <label>:6                                       ; preds = %4
  %7 = tail call zeroext i1 @klee_is_normal_double(double %f) #11, !dbg !290
...
define i32 @klee_internal_fpclassifyl(x86_fp80 %ld) #3 {
  %1 = tail call zeroext i1 @klee_is_nan_long_double(x86_fp80 %ld) #11, !dbg !295
  br i1 %1, label %8, label %2, !dbg !295

; <label>:2                                       ; preds = %0
  %3 = tail call zeroext i1 @klee_is_infinite_long_double(x86_fp80 %ld) #11, !dbg !297
...
; <label>:6                                       ; preds = %4
  %7 = tail call zeroext i1 @klee_is_normal_long_double(x86_fp80 %ld) #11, !dbg !301
...
define i32 @klee_internal_finitef(float %f) #3 {
  %1 = tail call zeroext i1 @klee_is_nan_float(float %f) #11, !dbg !306
  %2 = zext i1 %1 to i32, !dbg !306
  %3 = xor i32 %2, 1, !dbg !306
  %4 = tail call zeroext i1 @klee_is_infinite_float(float %f) #11, !dbg !306
...
define i32 @klee_internal_finite(double %f) #3 {
  %1 = tail call zeroext i1 @klee_is_nan_double(double %f) #11, !dbg !307
  %2 = zext i1 %1 to i32, !dbg !307
  %3 = xor i32 %2, 1, !dbg !307
  %4 = tail call zeroext i1 @klee_is_infinite_double(double %f) #11, !dbg !307
...
define i32 @klee_internal_finitel(x86_fp80 %f) #3 {
  %1 = tail call zeroext i1 @klee_is_nan_long_double(x86_fp80 %f) #11, !dbg !308
  %2 = zext i1 %1 to i32, !dbg !308
  %3 = xor i32 %2, 1, !dbg !308
  %4 = tail call zeroext i1 @klee_is_infinite_long_double(x86_fp80 %f) #11, !dbg !308
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([81 x i8]* @.str2, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str13, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str24, i64 0, i64 0)) #12, !dbg !311
  unreachable, !dbg !311
...
define i32 @klee_int(i8* %name) #3 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #11, !dbg !313
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #12, !dbg !317
  unreachable, !dbg !317
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([72 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #12, !dbg !322
  unreachable, !dbg !322
...
; <label>:6                                       ; preds = %3
  ...
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #11, !dbg !325
...
; <label>:1                                       ; preds = %0
  tail call void @klee_set_rounding_mode_internal(i32 0) #11, !dbg !338
  br label %7, !dbg !338

; <label>:2                                       ; preds = %0
  tail call void @klee_set_rounding_mode_internal(i32 1) #11, !dbg !340
  br label %7, !dbg !340

; <label>:3                                       ; preds = %0
  tail call void @klee_set_rounding_mode_internal(i32 2) #11, !dbg !341
  br label %7, !dbg !341

; <label>:4                                       ; preds = %0
  tail call void @klee_set_rounding_mode_internal(i32 3) #11, !dbg !342
  br label %7, !dbg !342

; <label>:5                                       ; preds = %0
  tail call void @klee_set_rounding_mode_internal(i32 4) #11, !dbg !343
  br label %7, !dbg !343

; <label>:6                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([84 x i8]* @.str9, i64 0, i64 0), i32 31, i8* getelementptr inbounds ([22 x i8]* @.str110, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str211, i64 0, i64 0)) #12, !dbg !344
  unreachable, !dbg !344
...
define double @klee_internal_sqrt(double %d) #3 {
  %1 = tail call double @klee_sqrt_double(double %d) #11, !dbg !377
...
define float @klee_internal_sqrtf(float %f) #3 {
  %1 = tail call float @klee_sqrt_float(float %f) #11, !dbg !378
  ret float %1, !dbg !378
}
...
define x86_fp80 @klee_internal_sqrtl(x86_fp80 %f) #3 {
  %1 = tail call x86_fp80 @klee_sqrt_long_double(x86_fp80 %f) #11, !dbg !379
...
!1 = metadata !{metadata !"div-SYMBOLIC.c", metadata !"/home/fptesting/FPTesting/example"}
!2 = metadata !{i32 0}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/fptesting/FPTesting/example/div-SYMBOLIC.c]
...
!239 = metadata !{i32 6, i32 0, metadata !4, null}
!240 = metadata !{i32 7, i32 0, metadata !4, null}
!241 = metadata !{i32 8, i32 0, metadata !4, null} ; [ DW_TAG_imported_declaration ]
!242 = metadata !{i32 9, i32 0, metadata !4, null}
