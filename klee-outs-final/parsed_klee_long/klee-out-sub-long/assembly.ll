...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = getelementptr inbounds [2 x float]* %in, i32 0, i32 0
  %3 = bitcast float* %2 to i8*
  call void @klee_make_symbolic(i8* %3, i64 8, i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0))
  %4 = getelementptr inbounds [2 x float]* %in, i32 0, i64 0
  %5 = load float* %4, align 4
  store volatile float %5, float* %a, align 4
  %6 = getelementptr inbounds [2 x float]* %in, i32 0, i64 1
