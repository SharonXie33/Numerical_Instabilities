; ModuleID = 'softmax-long.linked.bc'
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = getelementptr inbounds [4 x float]* %in, i32 0, i32 0
  %3 = bitcast float* %2 to i8*
  call void @klee_make_symbolic(i8* %3, i64 16, i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0))
  %4 = getelementptr inbounds [4 x float]* %in, i32 0, i64 0
  %5 = load float* %4, align 4
  store volatile float %5, float* %maxv, align 4
...
; <label>:9                                       ; preds = %6
  ...
  %12 = getelementptr inbounds [4 x float]* %in, i32 0, i64 %11
  %13 = load float* %12, align 4
  %14 = load volatile float* %maxv, align 4
...
; <label>:16                                      ; preds = %9
  ...
  %19 = getelementptr inbounds [4 x float]* %in, i32 0, i64 %18
  %20 = load float* %19, align 4
  store volatile float %20, float* %maxv, align 4
  br label %21
...
; <label>:24                                      ; preds = %6
  store volatile float 0.000000e+00, float* %sum, align 4
...
; <label>:28                                      ; preds = %25
  ...
  %31 = getelementptr inbounds [4 x float]* %in, i32 0, i64 %30
  %32 = load float* %31, align 4
  %33 = load volatile float* %maxv, align 4
  %34 = fsub float %32, %33
  %35 = call float @expf(float %34) #6
  %36 = load i32* %i1, align 4
  %37 = sext i32 %36 to i64
  %38 = getelementptr inbounds [4 x float]* %exps, i32 0, i64 %37
  store volatile float %35, float* %38, align 4
  %39 = load i32* %i1, align 4
  %40 = sext i32 %39 to i64
  %41 = getelementptr inbounds [4 x float]* %exps, i32 0, i64 %40
  %42 = load volatile float* %41, align 4
  %43 = load volatile float* %sum, align 4
  %44 = fadd float %43, %42
  store volatile float %44, float* %sum, align 4
...
; <label>:47                                      ; preds = %25
  %48 = getelementptr inbounds [4 x float]* %exps, i32 0, i64 0
  %49 = load volatile float* %48, align 4
  %50 = load volatile float* %sum, align 4
  %51 = fdiv float %49, %50
  store volatile float %51, float* %out0, align 4
  %52 = load volatile float* %out0, align 4
  %53 = fpext float %52 to double
  %54 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i32 0, i32 0), double %53)
  ret i32 0
}
