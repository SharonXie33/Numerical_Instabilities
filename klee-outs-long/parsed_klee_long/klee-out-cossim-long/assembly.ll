; ModuleID = 'cossim-long.linked.bc'
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = getelementptr inbounds [3 x float]* %x, i32 0, i32 0
  %3 = bitcast float* %2 to i8*
  call void @klee_make_symbolic(i8* %3, i64 12, i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0))
  %4 = getelementptr inbounds [3 x float]* %y, i32 0, i32 0
  %5 = bitcast float* %4 to i8*
  call void @klee_make_symbolic(i8* %5, i64 12, i8* getelementptr inbounds ([2 x i8]* @.str1, i32 0, i32 0))
  store volatile float 0.000000e+00, float* %dot, align 4
  store volatile float 0.000000e+00, float* %nx, align 4
  store volatile float 0.000000e+00, float* %ny, align 4
...
; <label>:9                                       ; preds = %6
  ...
  %12 = getelementptr inbounds [3 x float]* %x, i32 0, i64 %11
  %13 = load float* %12, align 4
  %14 = load i32* %i, align 4
  %15 = sext i32 %14 to i64
  %16 = getelementptr inbounds [3 x float]* %y, i32 0, i64 %15
  %17 = load float* %16, align 4
  %18 = fmul float %13, %17
  %19 = load volatile float* %dot, align 4
  %20 = fadd float %19, %18
  store volatile float %20, float* %dot, align 4
  %21 = load i32* %i, align 4
  %22 = sext i32 %21 to i64
  %23 = getelementptr inbounds [3 x float]* %x, i32 0, i64 %22
  %24 = load float* %23, align 4
  %25 = load i32* %i, align 4
  %26 = sext i32 %25 to i64
  %27 = getelementptr inbounds [3 x float]* %x, i32 0, i64 %26
  %28 = load float* %27, align 4
  %29 = fmul float %24, %28
  %30 = load volatile float* %nx, align 4
  %31 = fadd float %30, %29
  store volatile float %31, float* %nx, align 4
  %32 = load i32* %i, align 4
  %33 = sext i32 %32 to i64
  %34 = getelementptr inbounds [3 x float]* %y, i32 0, i64 %33
  %35 = load float* %34, align 4
  %36 = load i32* %i, align 4
  %37 = sext i32 %36 to i64
  %38 = getelementptr inbounds [3 x float]* %y, i32 0, i64 %37
  %39 = load float* %38, align 4
  %40 = fmul float %35, %39
  %41 = load volatile float* %ny, align 4
  %42 = fadd float %41, %40
  store volatile float %42, float* %ny, align 4
...
; <label>:45                                      ; preds = %6
  %46 = load volatile float* %nx, align 4
  %47 = call float @klee_internal_sqrtf(float %46) #5
  %48 = load volatile float* %ny, align 4
  %49 = call float @klee_internal_sqrtf(float %48) #5
  %50 = fmul float %47, %49
  store volatile float %50, float* %denom, align 4
  %51 = load volatile float* %denom, align 4
  %52 = fcmp oeq float %51, 0.000000e+00
  br i1 %52, label %57, label %53

; <label>:53                                      ; preds = %45
  %54 = load volatile float* %dot, align 4
  %55 = load volatile float* %denom, align 4
  %56 = fdiv float %54, %55
  br label %57

; <label>:57                                      ; preds = %45, %53
  %58 = phi float [ %56, %53 ], [ 0.000000e+00, %45 ]
  store volatile float %58, float* %r, align 4
  %59 = load volatile float* %r, align 4
  %60 = fpext float %59 to double
  %61 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str2, i32 0, i32 0), double %60)
  ret i32 0
}
...
; Function Attrs: nounwind uwtable
define void @fp_injection(i8* nocapture readonly %psrc1, i8* nocapture readonly %psrc2, i8* nocapture readonly %pdest) #2 {
  %1 = bitcast i8* %psrc1 to double*
  %2 = load double* %1, align 8, !tbaa !234
  %3 = tail call i32 @klee_internal_fpclassify(double %2) #9
  %4 = icmp eq i32 %3, 4
  %5 = bitcast i8* %psrc2 to double*
  %6 = load double* %5, align 8, !tbaa !234
  %7 = tail call i32 @klee_internal_fpclassify(double %6) #9
  %8 = icmp eq i32 %7, 4
  %9 = and i1 %4, %8
...
; Function Attrs: nounwind uwtable
define void @cancel_injection(i8* nocapture readonly %psrc1, i8* nocapture readonly %psrc2, i8* nocapture readonly %pdest) #2 {
  ...
  %20 = tail call i32 @klee_internal_fpclassify(double %19) #9
  %21 = icmp eq i32 %20, 4
  %22 = and i1 %18, %21
  %23 = bitcast i64 %6 to double
  %24 = tail call i32 @klee_internal_fpclassify(double %23) #9
  %25 = icmp eq i32 %24, 4
  %26 = and i1 %22, %25
...
; Function Attrs: nounwind uwtable
define void @round_injection(i8* nocapture readonly %psrc1, i8* nocapture readonly %psrc2, i8* nocapture readnone %pdest) #2 {
  %1 = bitcast i8* %psrc1 to i64*
  %2 = load i64* %1, align 8, !tbaa !238
  %int_cast_to_i64 = bitcast i64 52 to i64
  call void @klee_overshift_check(i64 64, i64 %int_cast_to_i64)
  ...
  %15 = tail call i32 @klee_internal_fpclassify(double %14) #9
  %16 = icmp eq i32 %15, 4
  %17 = and i1 %13, %16
  %18 = bitcast i64 %6 to double
  %19 = tail call i32 @klee_internal_fpclassify(double %18) #9
  %20 = icmp eq i32 %19, 4
  %21 = and i1 %17, %20
  br i1 %21, label %22, label %23
...
; Function Attrs: nounwind uwtable
define void @log_sampled_fp_injection(i8* nocapture readonly %psrc1, i8* nocapture readonly %psrc2, i8* nocapture readonly %pdest, i32* nocapture %pcounter, i32 %step, i32 %injection) #2 {
...
; <label>:3                                       ; preds = %0
  ...
  %7 = tail call double @ceil(double %6) #9
...
; <label>:19                                      ; preds = %16
  ...
  %34 = tail call i32 @klee_internal_fpclassify(double %33) #9
  %35 = icmp eq i32 %34, 4
  %36 = and i1 %32, %35
  %37 = bitcast i64 %25 to double
  %38 = tail call i32 @klee_internal_fpclassify(double %37) #9
  %39 = icmp eq i32 %38, 4
  %40 = and i1 %36, %39
...
; Function Attrs: nounwind uwtable
define void @uniform_sampled_fp_injection(i8* nocapture readonly %psrc1, i8* nocapture readonly %psrc2, i8* nocapture readonly %pdest, i32* nocapture %pcounter, i32 %step, i32 %injection) #2 {
  %1 = load i32* %pcounter, align 4, !tbaa !240
  %2 = icmp eq i32 %1, 2147483647
  br i1 %2, label %round_injection.exit, label %3
...
; <label>:10                                      ; preds = %7
  ...
  %25 = tail call i32 @klee_internal_fpclassify(double %24) #9
  %26 = icmp eq i32 %25, 4
  %27 = and i1 %23, %26
  %28 = bitcast i64 %16 to double
  %29 = tail call i32 @klee_internal_fpclassify(double %28) #9
  %30 = icmp eq i32 %29, 4
  %31 = and i1 %27, %30
...
declare zeroext i1 @klee_is_infinite_float(float) #6

declare zeroext i1 @klee_is_infinite_double(double) #6

declare zeroext i1 @klee_is_infinite_long_double(x86_fp80) #6

; Function Attrs: noinline nounwind optnone uwtable
define i32 @klee_internal_isinff(float %f) #7 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define i32 @klee_internal_isinf(double %d) #7 {
entry:
...
define i32 @klee_internal_isinfl(x86_fp80 %d) #8 {
entry:
...
; Function Attrs: nounwind uwtable
define double @klee_internal_fabs(double %d) #2 {
  %1 = tail call double @klee_abs_double(double %d) #11, !dbg !242
  ret double %1, !dbg !242
}

declare double @klee_abs_double(double) #6

; Function Attrs: nounwind uwtable
define float @klee_internal_fabsf(float %f) #2 {
  %1 = tail call float @klee_abs_float(float %f) #11, !dbg !243
  ret float %1, !dbg !243
}

declare float @klee_abs_float(float) #6

; Function Attrs: nounwind uwtable
define x86_fp80 @klee_internal_fabsl(x86_fp80 %f) #2 {
  %1 = tail call x86_fp80 @klee_abs_long_double(x86_fp80 %f) #11, !dbg !244
  ret x86_fp80 %1, !dbg !244
}

declare x86_fp80 @klee_abs_long_double(x86_fp80) #6

; Function Attrs: nounwind readnone
declare void @llvm.dbg.value(metadata, i64, metadata) #9

; Function Attrs: nounwind uwtable
define i32 @klee_internal_fegetround() #2 {
  %1 = tail call i32 (...)* @klee_get_rounding_mode() #11, !dbg !245
...
declare i32 @klee_get_rounding_mode(...) #6

; Function Attrs: nounwind uwtable
define i32 @klee_internal_fesetround(i32 %rm) #2 {
...
; <label>:1                                       ; preds = %0
  tail call void @klee_set_rounding_mode(i32 0) #11, !dbg !249
  br label %5, !dbg !251

; <label>:2                                       ; preds = %0
  tail call void @klee_set_rounding_mode(i32 2) #11, !dbg !252
  br label %5, !dbg !253

; <label>:3                                       ; preds = %0
  tail call void @klee_set_rounding_mode(i32 3) #11, !dbg !254
  br label %5, !dbg !255

; <label>:4                                       ; preds = %0
  tail call void @klee_set_rounding_mode(i32 4) #11, !dbg !256
  br label %5, !dbg !257
...
; Function Attrs: nounwind uwtable
define i32 @klee_internal_isnanf(float %f) #2 {
  %1 = tail call zeroext i1 @klee_is_nan_float(float %f) #11, !dbg !259
  %2 = zext i1 %1 to i32, !dbg !259
  ret i32 %2, !dbg !259
}

declare zeroext i1 @klee_is_nan_float(float) #6

; Function Attrs: nounwind uwtable
define i32 @klee_internal_isnan(double %d) #2 {
  %1 = tail call zeroext i1 @klee_is_nan_double(double %d) #11, !dbg !260
  %2 = zext i1 %1 to i32, !dbg !260
  ret i32 %2, !dbg !260
}

declare zeroext i1 @klee_is_nan_double(double) #6

; Function Attrs: nounwind uwtable
define i32 @klee_internal_isnanl(x86_fp80 %d) #2 {
  %1 = tail call zeroext i1 @klee_is_nan_long_double(x86_fp80 %d) #11, !dbg !261
  %2 = zext i1 %1 to i32, !dbg !261
  ret i32 %2, !dbg !261
}

declare zeroext i1 @klee_is_nan_long_double(x86_fp80) #6

; Function Attrs: nounwind uwtable
define i32 @klee_internal_fpclassifyf(float %f) #2 {
  %1 = tail call zeroext i1 @klee_is_nan_float(float %f) #11, !dbg !262
  br i1 %1, label %8, label %2, !dbg !262

; <label>:2                                       ; preds = %0
  %3 = tail call zeroext i1 @klee_is_infinite_float(float %f) #11, !dbg !264
...
; <label>:6                                       ; preds = %4
  %7 = tail call zeroext i1 @klee_is_normal_float(float %f) #11, !dbg !268
...
declare zeroext i1 @klee_is_normal_float(float) #6

; Function Attrs: nounwind uwtable
define i32 @klee_internal_fpclassify(double %f) #2 {
  %1 = tail call zeroext i1 @klee_is_nan_double(double %f) #11, !dbg !273
  br i1 %1, label %8, label %2, !dbg !273

; <label>:2                                       ; preds = %0
  %3 = tail call zeroext i1 @klee_is_infinite_double(double %f) #11, !dbg !275
...
; <label>:6                                       ; preds = %4
  %7 = tail call zeroext i1 @klee_is_normal_double(double %f) #11, !dbg !279
...
declare zeroext i1 @klee_is_normal_double(double) #6

; Function Attrs: nounwind uwtable
define i32 @klee_internal_fpclassifyl(x86_fp80 %ld) #2 {
  %1 = tail call zeroext i1 @klee_is_nan_long_double(x86_fp80 %ld) #11, !dbg !284
  br i1 %1, label %8, label %2, !dbg !284

; <label>:2                                       ; preds = %0
  %3 = tail call zeroext i1 @klee_is_infinite_long_double(x86_fp80 %ld) #11, !dbg !286
...
; <label>:6                                       ; preds = %4
  %7 = tail call zeroext i1 @klee_is_normal_long_double(x86_fp80 %ld) #11, !dbg !290
...
declare zeroext i1 @klee_is_normal_long_double(x86_fp80) #6

; Function Attrs: nounwind uwtable
define i32 @klee_internal_finitef(float %f) #2 {
  %1 = tail call zeroext i1 @klee_is_nan_float(float %f) #11, !dbg !295
  %2 = zext i1 %1 to i32, !dbg !295
  %3 = xor i32 %2, 1, !dbg !295
  %4 = tail call zeroext i1 @klee_is_infinite_float(float %f) #11, !dbg !295
...
; Function Attrs: nounwind uwtable
define i32 @klee_internal_finite(double %f) #2 {
  %1 = tail call zeroext i1 @klee_is_nan_double(double %f) #11, !dbg !296
  %2 = zext i1 %1 to i32, !dbg !296
  %3 = xor i32 %2, 1, !dbg !296
  %4 = tail call zeroext i1 @klee_is_infinite_double(double %f) #11, !dbg !296
...
; Function Attrs: nounwind uwtable
define i32 @klee_internal_finitel(x86_fp80 %f) #2 {
  %1 = tail call zeroext i1 @klee_is_nan_long_double(x86_fp80 %f) #11, !dbg !297
  %2 = zext i1 %1 to i32, !dbg !297
  %3 = xor i32 %2, 1, !dbg !297
  %4 = tail call zeroext i1 @klee_is_infinite_long_double(x86_fp80 %f) #11, !dbg !297
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([81 x i8]* @.str3, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str25, i64 0, i64 0)) #12, !dbg !300
  unreachable, !dbg !300
...
define i32 @klee_int(i8* %name) #2 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #11, !dbg !302
  %2 = load i32* %x, align 4, !dbg !303, !tbaa !240
  ret i32 %2, !dbg !303
}

; Function Attrs: nounwind readnone
declare void @llvm.dbg.declare(metadata, metadata) #9
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str36, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str147, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str258, i64 0, i64 0)) #12, !dbg !306
  unreachable, !dbg !306
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([72 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #12, !dbg !311
  unreachable, !dbg !311
...
; <label>:6                                       ; preds = %3
  ...
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #11, !dbg !314
...
; Function Attrs: nounwind uwtable
define void @klee_set_rounding_mode(i32 %rm) #2 {
...
; <label>:1                                       ; preds = %0
  tail call void @klee_set_rounding_mode_internal(i32 0) #11, !dbg !327
  br label %7, !dbg !327

; <label>:2                                       ; preds = %0
  tail call void @klee_set_rounding_mode_internal(i32 1) #11, !dbg !329
  br label %7, !dbg !329

; <label>:3                                       ; preds = %0
  tail call void @klee_set_rounding_mode_internal(i32 2) #11, !dbg !330
  br label %7, !dbg !330

; <label>:4                                       ; preds = %0
  tail call void @klee_set_rounding_mode_internal(i32 3) #11, !dbg !331
  br label %7, !dbg !331

; <label>:5                                       ; preds = %0
  tail call void @klee_set_rounding_mode_internal(i32 4) #11, !dbg !332
  br label %7, !dbg !332

; <label>:6                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([84 x i8]* @.str9, i64 0, i64 0), i32 31, i8* getelementptr inbounds ([22 x i8]* @.str110, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str211, i64 0, i64 0)) #12, !dbg !333
  unreachable, !dbg !333
...
declare void @klee_set_rounding_mode_internal(i32) #6
...
; Function Attrs: nounwind uwtable
define double @klee_internal_sqrt(double %d) #2 {
  %1 = tail call double @klee_sqrt_double(double %d) #11, !dbg !366
  ret double %1, !dbg !366
}

declare double @klee_sqrt_double(double) #6

; Function Attrs: nounwind uwtable
define float @klee_internal_sqrtf(float %f) #2 {
  %1 = tail call float @klee_sqrt_float(float %f) #11, !dbg !367
  ret float %1, !dbg !367
}

declare float @klee_sqrt_float(float) #6

; Function Attrs: nounwind uwtable
define x86_fp80 @klee_internal_sqrtl(x86_fp80 %f) #2 {
  %1 = tail call x86_fp80 @klee_sqrt_long_double(x86_fp80 %f) #11, !dbg !368
  ret x86_fp80 %1, !dbg !368
}

declare x86_fp80 @klee_sqrt_long_double(x86_fp80) #6
...
attributes #7 = { noinline nounwind optnone uwtable "less-precise-fpmad"="false" "no-frame-pointer-elim"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-float"="false" }
